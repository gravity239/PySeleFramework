...
class Test1GoogleSearchTest(TestBase):
    ...
    def test_search_001(self):
        ...
        try:
            ...
            self.google_home.search_parent("hello selenium parent 1")
            ...
            self.explore_validations(validations, sys.exc_info(), self._testMethodName)
